...
| CRISPR screen prioritization, guide counts, depleted genes, knockout screen hits, rank CRISPR hits, follow-up genes | `skills/crispr-screen-prioritizer/` | Run `crispr_screen_prioritizer.py` |
...
# CRISPR screen prioritizer — deterministic guide-level hit ranking
python skills/crispr-screen-prioritizer/crispr_screen_prioritizer.py \
  --input <screen_counts.csv> --output <report_dir>
python skills/crispr-screen-prioritizer/crispr_screen_prioritizer.py --demo --output /tmp/crispr_prioritize_demo
...
| CRISPR screen demo counts (12 synthetic guides, 6 genes) | `skills/crispr-screen-prioritizer/demo_screen_counts.csv` | crispr-screen-prioritizer |
...
# CRISPR screen prioritizer demo
python skills/crispr-screen-prioritizer/crispr_screen_prioritizer.py --demo --output /tmp/crispr_prioritize_demo
