...
| Spatial transcriptomics mapping, map spatial spots, marker-based tissue regions, tumor core, immune edge | `skills/spatial-transcriptomics-mapper/` | Run `spatial_transcriptomics_mapper.py` |
...
# Spatial transcriptomics mapper — marker-based spot region mapping
python skills/spatial-transcriptomics-mapper/spatial_transcriptomics_mapper.py \
  --input <spot_counts.csv> --output <report_dir>
python skills/spatial-transcriptomics-mapper/spatial_transcriptomics_mapper.py --demo --output /tmp/spatial_map_demo
...
| Spatial transcriptomics demo counts (6 synthetic spots) | `skills/spatial-transcriptomics-mapper/demo_spatial_counts.csv` | spatial-transcriptomics-mapper |
...
# Spatial transcriptomics mapper demo
python skills/spatial-transcriptomics-mapper/spatial_transcriptomics_mapper.py --demo --output /tmp/spatial_map_demo
